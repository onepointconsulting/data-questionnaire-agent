...
INSERT INTO TB_QUESTION_SUGGESTIONS(IMG_SRC, IMG_ALT, TITLE, MAIN_TEXT, QUESTION_ID)
	VALUES('document-related-issues.jpg', 'Dokumentbezogene Probleme', 'Dokumentbezogene Probleme', 'Ich habe Probleme mit meinen Rechtsdokumenten oder meinem Ausweis.',
...
INSERT INTO TB_QUESTION_SUGGESTIONS(IMG_SRC, IMG_ALT, TITLE, MAIN_TEXT, QUESTION_ID)
	VALUES('healthcare-access.jpg', 'Zugang zur Gesundheitsversorgung', 'Zugang zur Gesundheitsversorgung', 'Ich benötige medizinische Hilfe oder habe Bedenken hinsichtlich des Zugangs zu Gesundheitsdiensten.',
	(SELECT ID FROM TB_QUESTION WHERE QUESTION = 'Mit welchen Herausforderungen sehen Sie sich als Flüchtling derzeit konfrontiert?'));
...
INSERT INTO TB_QUESTION_SUGGESTIONS(IMG_SRC, IMG_ALT, TITLE, MAIN_TEXT, QUESTION_ID)
	VALUES('asylum-procedure.jpg', 'Asylverfahren', 'Asylverfahren', 'Ich benötige rechtliche Unterstützung oder Beratung zum Asylverfahren in meinem Gastland.',
	(SELECT ID FROM TB_QUESTION WHERE QUESTION = 'Mit welchen Herausforderungen sehen Sie sich als Flüchtling derzeit konfrontiert?'));
